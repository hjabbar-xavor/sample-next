...
export async function getPageStaticPropsForPath(params, preview = false) {
  ...
  // TODO implement if not found! And add preview URL to configure preview URLs from Kontent.
  ...
  const result = {
    ...
    linkedItems: JSON.parse(JSON.stringify(response.linkedItems)), // TODO polish serialization of the js SDK response
    data: {
