...
> ⚠ This repository is still in the concept phase. There is stil [a bunch of tasks to be done](https://github.com/Kentico/kontent-starter-corporate-next-js/issues). If you have any feedback to any part of the code, feel free to raise and issue and discuss your ides.
